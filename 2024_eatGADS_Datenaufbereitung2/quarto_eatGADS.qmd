...
eatGADS-Datenstruktur:
Liste bestehend aus rohen Daten und Meta-Daten
...
<div style="text-align: center;">
  <h1 style="font-size: 2em;">Danke für Eure</h1>
  <h1 style="font-size: 2em;">Aufmerksamkeit!</h1>
</div>

\vspace{2cm}

<div style="font-size: small;">
  [https://CRAN.R-project.org/package=eatGADS](https://CRAN.R-project.org/package=eatGADS)  
  [https://github.com/beckerbenj/eatFDZ](https://github.com/beckerbenj/eatFDZ)
</div>
