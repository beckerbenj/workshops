...
Nicht händisch, sondern Verwendung von Optimierungsalgorithmen

## Agenda

1. Hintergrund: Wofür?
2. Mathematical Programming
3. Automated Test Assembly/Automatisierte Blockbesetzung
4. eatATA
...
- Löst das vorgestellte Produzentenproblem händisch!
...
- Es gibt häufig mehrere Wege zum Ziel
- Pragmatisches Vorgehen: Häufig muss die Lösung nicht perfekt sein
- Schrittweises Vorgehen: ATA-Problem aufbauen [@Proietti.2020]
